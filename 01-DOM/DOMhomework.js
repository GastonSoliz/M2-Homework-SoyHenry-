...
let span = document.querySelector('#createdBy');
  span.innerHTML = span.innerHTML + ' Gaston';
...
function buildToDo(todo, index) {
  ...
  //Creamos un div y su class='toDoShell';

  let toDoText = document.createElement('span');
  toDoText.innerHTML = todo.description;

  //Creamos un span y le añadimos contenido que viene del parametro todo

  toDoText.id = index;

  //Añadir identificador que viene del parametro index al span
  ...
  //Si el contenido del parametro es true, se le agrega class='completeText'

  toDoShell.appendChild(toDoText);
  //Se agrega el span al div
